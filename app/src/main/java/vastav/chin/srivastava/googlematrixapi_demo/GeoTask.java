    ...
    protected void onPostExecute(String aDouble) {
        ...
        if(aDouble!=null)
        {
         geo1.setDouble(aDouble);
            ...
            Toast.makeText(mContext,aDouble, Toast.LENGTH_SHORT).show();
    }
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            if(statuscode==HttpURLConnection.HTTP_OK)
            {
                ...
                JSONObject  object_elements1=array_elements.getJSONObject(1);
                JSONObject object_duration2 = object_elements1.getJSONObject("duration");
                JSONObject object_distance2 = object_elements1.getJSONObject("distance");
                if(!object_elements1.equals(null)) {
                    Log.d("JSON", "object_duration:" + object_duration);
                    return object_duration.getString("value") + "," + object_distance.getString("value")+";"
                            +object_duration2.getString("value") + "," + object_distance2.getString("value");
                }
